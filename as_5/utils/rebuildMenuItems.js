/**
 * THIS IS NOT A NODE PROGRAM!
 *
 * Script to create the 'menuitems' collection in the 'restaurantdb' database.
 * Note that any existing data will be lost.
 *
 * There are two ways to run this script.
 *   1. If Mongo is installed as a node package, start a command prompt
 *      and enter "mongo rebuildMenuItems.js" ("mongo", not "node")
 *   2. Enter the Mongo shell and enter load("rebuildMenuItems.js")
 */
// eslint-disable-next-line no-undef
const db = connect("localhost:27017/restaurantdb");
db.menuitems.drop(); // start with a new collection
db.menuitems.insertMany([
    ...
    },
    {
        id: 205,
        category: "ENT",
        description: "boneless quails stuffed with foie gras and truffles",
        price: 32,
        vegetarian: false,
    },
    {
